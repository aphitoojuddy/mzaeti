...
{
    function css_url($fname = '')
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('css_path') . $fname;
    }
}
...
{
    function font_url($fname = '')
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('font_path') . $fname;
    }
}
...
if ( ! function_exists('js_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('js_path') . $fname;
    }
}
...
{
    function img_url($fname = '')
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('img_path') . $fname;
    }
}
...
{
    function swf_url($fname = '')
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('swf_path') . $fname;
    }
}
...
{
    function download_url($fname = '')
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('download_path') . $fname;
    }
}
