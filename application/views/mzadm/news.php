				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-align-right">
						<div class="page-title">
							<a href="<?=site_url('mzadm/news/add')?>" class="btn btn-default">Add News</a>
						</div>
					</div>
				</div>
				<!-- end row -->
						...
						<div class="well padding-10">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<!-- <a class="btn btn-primary" href="<?=site_url('mzadm/news/view/'.$value->article_id)?>"> Read more </a> -->
									<a class="btn btn-warning" href="<?=site_url('mzadm/news/edit/'.$value->article_id)?>"> Edit </a>
									<a class="btn btn-danger" href="<?=site_url('mzadm/news/delete/'.$value->article_id)?>"> Delete </a>
								</div>
							</div>
							<hr>
							<?php
