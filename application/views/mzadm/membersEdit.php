								...
								<form class="form-horizontal" method="POST" action="<?=site_url('mzadm/members/upload_file/')?>" enctype="multipart/form-data" onsubmit="return postForm()">
									<fieldset>
										...
										<div class="form-group <?=(!empty($error_msg['i_title_id']) ? 'has-error' : '')?>">
											...
											<div class="col-md-10">
												<input class="form-control" placeholder="" type="text" name="i_title_id" id="i_title_id" value="<?=$members_data->article_title_id?>">
										...
										<div class="form-group <?=(!empty($error_msg['i_content_id']) ? 'has-error' : '')?>">
											...
											<div class="col-md-10">
												<textarea class="form-control summernote" placeholder="" rows="4" name="i_content_id" id="i_content_id"><?=$members_data->article_content_id?></textarea>												
									...
									<fieldset>
										...
										<div class="form-group <?=(!empty($error_msg['i_title_en']) ? 'has-error' : '')?>">
											<label class="col-md-2 control-label">Title :</label>
											<div class="col-md-10">
												<input class="form-control" placeholder="" type="text" name="i_title_en" id="i_title_en" value="<?=$members_data->article_title_en?>">
										...
										<div class="form-group <?=(!empty($error_msg['i_content_en']) ? 'has-error' : '')?>">
											<label class="col-md-2 control-label">Content :</label>
											<div class="col-md-10">
												<textarea class="form-control summernote" placeholder="" rows="4" name="i_content_en" id="i_content_en"><?=$members_data->article_content_en?></textarea>												
									...
									<fieldset>
										...
										<div class="smart-form form-group <?=(!empty($error_msg['i_image_file']) ? 'has-error' : '')?>">
											...
											<div class="col-md-10"><img src="<?=img_url('logo/'.$members_data->downloadable_content_extra)?>" style="max-width:100px;"></div>
											<label class="col-md-2 control-label" style="padding-top: 20px;">Logo File :</label>
