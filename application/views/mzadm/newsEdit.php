					...
					<div class="well">
						...
						<div>
							...
							<div class="widget-body">
								...
								<form class="form-horizontal" method="POST" action="<?=site_url('mzadm/news/edit/'.$news_data->article_id)?>" enctype="multipart/form-data" onsubmit="return postForm()">
									<fieldset>
										<legend>Indonesian Version</legend>
										<div class="form-group <?=(!empty($error_msg['i_title_id']) ? 'has-error' : '')?>">
											<label class="col-md-2 control-label">Title :</label>
											<div class="col-md-10">
												<input class="form-control" placeholder="" type="text" name="i_title_id" id="i_title_id" value="<?=$news_data->article_title_id?>">
										...
										<div class="form-group <?=(!empty($error_msg['i_content_id']) ? 'has-error' : '')?>">
											...
											<div class="col-md-10">
												<textarea class="form-control summernote" placeholder="" rows="4" name="i_content_id" id="i_content_id"><?=$news_data->article_content_id?></textarea>												
									...
									<fieldset>
										...
										<div class="form-group <?=(!empty($error_msg['i_title_en']) ? 'has-error' : '')?>">
											<label class="col-md-2 control-label">Title :</label>
											<div class="col-md-10">
												<input class="form-control" placeholder="" type="text" name="i_title_en" id="i_title_en" value="<?=$news_data->article_title_en?>">
										...
										<div class="form-group <?=(!empty($error_msg['i_content_en']) ? 'has-error' : '')?>">
											<label class="col-md-2 control-label">Content :</label>
											<div class="col-md-10">
												<textarea class="form-control summernote" placeholder="" rows="4" name="i_content_en" id="i_content_en"><?=$news_data->article_content_en?></textarea>												
